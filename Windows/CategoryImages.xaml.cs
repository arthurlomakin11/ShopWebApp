...
{
    public partial class CategoryImages : Window
    {
        Category Category;
        ShopWebContext Context;
        FtpClient client;
        string WorkingDirectory;
        public CategoryImages(Category Category, ShopWebContext Context)
        {
            InitializeComponent();
        ...
        {            
            ...
            foreach (Image i in Category.Images)
            {
        ...
        private void UploadFile_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (op.ShowDialog() == true)
            {
                ...
                for(;;)
                {
                    NewFileName = "category_img" + Category.Id + "_" + Count;
